...
<form method="" action="" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 ">
            <a data-fancybox-trigger="preview" data-fancybox-index="1" href="javascript:;" class="btn btn-info"><i class="fa fa-picture-o fa-fw"></i> Foto</a>
            @foreach ($data->fotos()->where('tag', 'form')->get() as $item)
                <a data-fancybox="preview" href="{{ asset('foto/'.$item->foto) }}">
    ...
    <div class="item form-group">
        ...
        @if (count($data->fotos()->where('tag', 'pondasi')->get()) > 0)
            <div class="col-md-3 col-sm-3 ">
                <a data-fancybox-trigger="pondasi" data-fancybox-index="1" href="javascript:;" class="btn btn-info"><i class="fa fa-picture-o fa-fw"></i> Foto</a>
    ...
    <div class="item form-group">
        ...
        @if (count($data->fotos()->where('tag', 'kolom_balok')->get()) > 0)
            <div class="col-md-3 col-sm-3 ">
                <a data-fancybox-trigger="kolom_balok" data-fancybox-index="1" href="javascript:;" class="btn btn-info"><i class="fa fa-picture-o fa-fw"></i> Foto</a>
    ...
    <div class="item form-group">
        ...
        @if (count($data->fotos()->where('tag', 'konstruksi_atap')->get()) > 0)
            <div class="col-md-3 col-sm-3 ">
                <a data-fancybox-trigger="konstruksi_atap" data-fancybox-index="1" href="javascript:;" class="btn btn-info"><i class="fa fa-picture-o fa-fw"></i> Foto</a>
    ...
    <div class="item form-group">
        ...
        @if (count($data->fotos()->where('tag', 'jendela')->get()) > 0)
            <div class="col-md-3 col-sm-3 ">
                <a data-fancybox-trigger="jendela" data-fancybox-index="1" href="javascript:;" class="btn btn-info"><i class="fa fa-picture-o fa-fw"></i> Foto</a>
    ...
    <div class="item form-group">
        ...
        @if (count($data->fotos()->where('tag', 'ventilasi')->get()) > 0)
            <div class="col-md-3 col-sm-3 ">
                <a data-fancybox-trigger="ventilasi" data-fancybox-index="1" href="javascript:;" class="btn btn-info"><i class="fa fa-picture-o fa-fw"></i> Foto</a>
                @foreach ($data->fotos()->where('tag', 'jendela')->get() as $item)
    ...
    <div class="item form-group">
        ...
        @if (count($data->fotos()->where('tag', 'kamar_mandi')->get()) > 0)
            <div class="col-md-3 col-sm-3 ">
                <a data-fancybox-trigger="kamar_mandi" data-fancybox-index="1" href="javascript:;" class="btn btn-info"><i class="fa fa-picture-o fa-fw"></i> Foto</a>
    ...
    <div class="item form-group">
        ...
        @if (count($data->fotos()->where('tag', 'jarak_air')->get()) > 0)
            <div class="col-md-3 col-sm-3 ">
                <a data-fancybox-trigger="jarak_air" data-fancybox-index="1" href="javascript:;" class="btn btn-info"><i class="fa fa-picture-o fa-fw"></i> Foto</a>
    ...
    <div class="item form-group">
        ...
        @if (count($data->fotos()->where('tag', 'sumber_air')->get()) > 0)
            <div class="col-md-3 col-sm-3 ">
                <a data-fancybox-trigger="sumber_air" data-fancybox-index="1" href="javascript:;" class="btn btn-info"><i class="fa fa-picture-o fa-fw"></i> Foto</a>
    ...
    <div class="item form-group">
        ...
        @if (count($data->fotos()->where('tag', 'sumber_listrik')->get()) > 0)
            <div class="col-md-3 col-sm-3 ">
                <a data-fancybox-trigger="sumber_listrik" data-fancybox-index="1" href="javascript:;" class="btn btn-info"><i class="fa fa-picture-o fa-fw"></i> Foto</a>
    ...
    <div class="item form-group">
        ...
        @if (count($data->fotos()->where('tag', 'material_atap')->get()) > 0)
            <div class="col-md-3 col-sm-3 ">
                <a data-fancybox-trigger="material_atap" data-fancybox-index="1" href="javascript:;" class="btn btn-info"><i class="fa fa-picture-o fa-fw"></i> Foto</a>
    ...
    <div class="item form-group">
        ...
        @if (count($data->fotos()->where('tag', 'kondisi_atap')->get()) > 0)
            <div class="col-md-3 col-sm-3 ">
                <a data-fancybox-trigger="kondisi_atap" data-fancybox-index="1" href="javascript:;" class="btn btn-info"><i class="fa fa-picture-o fa-fw"></i> Foto</a>
    ...
    <div class="item form-group">
        ...
        @if (count($data->fotos()->where('tag', 'material_dinding')->get()) > 0)
            <div class="col-md-3 col-sm-3 ">
                <a data-fancybox-trigger="material_dinding" data-fancybox-index="1" href="javascript:;" class="btn btn-info"><i class="fa fa-picture-o fa-fw"></i> Foto</a>
    ...
    <div class="item form-group">
        ...
        @if (count($data->fotos()->where('tag', 'kondisi_dinding')->get()) > 0)
            <div class="col-md-3 col-sm-3 ">
                <a data-fancybox-trigger="kondisi_dinding" data-fancybox-index="1" href="javascript:;" class="btn btn-info"><i class="fa fa-picture-o fa-fw"></i> Foto</a>
    ...
    <div class="item form-group">
        ...
        @if (count($data->fotos()->where('tag', 'material_lantai')->get()) > 0)
            <div class="col-md-3 col-sm-3 ">
                <a data-fancybox-trigger="material_lantai" data-fancybox-index="1" href="javascript:;" class="btn btn-info"><i class="fa fa-picture-o fa-fw"></i> Foto</a>
    ...
    <div class="item form-group">
        ...
        @if (count($data->fotos()->where('tag', 'kondisi_lantai')->get()) > 0)
            <div class="col-md-3 col-sm-3 ">
                <a data-fancybox-trigger="kondisi_lantai" data-fancybox-index="1" href="javascript:;" class="btn btn-info"><i class="fa fa-picture-o fa-fw"></i> Foto</a>
